                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="d-flex justify-content-between mt-2">
                                            <div class="form-group form-inline">
                                                ...
                                                <asp:DropDownList ID="ddlReview" runat="server" CssClass="form-control ml-2">
                                                    <asp:ListItem Text="Accept Fix" Value="Verified"></asp:ListItem>
                                                    <asp:ListItem Text="Reject Fix" Value="Assigned"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                            <div class="form-group form-inline">
                                                <asp:Label ID="Label3" runat="server" CssClass="col-form-label"></asp:Label>
                                                <button id="btnSubmit" runat="server" onserverclick="btnSubmit_Click" class="btn btn-success">Review fix</button>
                                            </div>
                                        </div>
