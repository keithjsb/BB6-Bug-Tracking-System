<%@ Page Title="" Language="C#" MasterPageFile="~/BugReporter/BugReporter.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="BB6.BugReporter.Home" %>
                            ...
                            <asp:Repeater runat="server" ID="Repeater1">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td style="vertical-align:middle"><asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%#Eval("bug_id", "~/BugReporter/Test1.aspx?id={0}")%>' CssClass="btn btn-secondary">Details</asp:HyperLink></td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
                        </thead>
