<%@ Page Title="" Language="C#" MasterPageFile="~/BugReporter/BugReporter.Master" AutoEventWireup="true" CodeBehind="ViewDetails.aspx.cs" Inherits="BB6.BugReporter.ViewDetails" %>
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-end mt-2">
                                ...
                                <asp:Label ID="Label3" runat="server" CssClass="col-form-label mr-2"></asp:Label>
